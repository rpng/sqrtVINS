...
#ifndef OV_SRVINS_ROS1VISUALIZER_H
#define OV_SRVINS_ROS1VISUALIZER_H
...
public:
  ...
  void callback_stereo(const sensor_msgs::ImageConstPtr &msg0,
                       const sensor_msgs::ImageConstPtr &msg1, int cam_id0,
                       int cam_id1);
...
protected:
  ...
  ros::Publisher pub_points_msckf, pub_points_slam, pub_points_aruco,
      pub_points_sim;
...
#endif // OV_SRVINS_ROS1VISUALIZER_H
